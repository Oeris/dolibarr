...
/**
 * 	\defgroup   oeriskanban     Module oeriskanban
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/oeriskanban/core/modules directory.
 *  \file       htdocs/mymodule/core/modules/modoeriskanban.class.php
 *  \ingroup    oeriskanban
 *  \brief      Description and activation file for module oeriskanban
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module oeriskanban
 */
class modoeriskanban extends DolibarrModules
{
	/**
    ...
    $this->db = $db;
		...
		$this->numero = 505052;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'oeriskanban';
		...
		$this->description = "Lie Dolibarr avec une instance Kanboard";
		$this->descriptionlong = "Permet de lier Dolibarr à une instance de Kanboard. Kanboard est un gestionnaire de tâche visuel qui permet de gérer facilement des petits projets de manière collaborative";
		$this->editor_name = 'Neil Orley';
		$this->editor_url = 'http://www.oeris.fr';
		...
		//                        );
		$this->module_parts = array('css' => array('/oeriskanban/css/oeriskanban.css','/oeriskanban/lib/bootstrap/css/bootstrap.min.css','/oeriskanban/lib/bootstrap/css/bootstrap-theme.min.css','/oeriskanban/lib/font-awesome/css/font-awesome.min.css'),
                                'js' => array('/oeriskanban/lib/bootstrap/js/bootstrap.min.js'));
		...
		//$this->config_page_url = array("setup.php@oeriskanban");
		...
		$this->langfiles = array("oeriskanboard@oeriskanban");
		...
		if (! isset($conf->oeriskanban) || ! isset($conf->oeriskanban->enabled))
        {
        	$conf->oeriskanban=new stdClass();
        	$conf->oeriskanban->enabled=0;
        }
    ...
    $this->menu[$r]=array(	
          'fk_menu'=>'',	// Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode of parent menu
    			...
    			'titre'=>'Kanboard',
    			'mainmenu'=>'oeriskanboard',
          'leftmenu'=>'oeriskanboard',
    			'url'=>'/oeriskanban/kanboard.php',
    			'langs'=>'oeriskanboard@oeriskanban',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
    			'position'=>100,
    			'enabled'=>'$conf->oeriskanban->enabled',			// Define condition to show or hide menu entry. Use '$conf->monmodule->enabled' if entry must be visible if module is enabled.
