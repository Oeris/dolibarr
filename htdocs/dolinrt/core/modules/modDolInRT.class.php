...
/**
 * 	\defgroup   DolInRT     Module DolInRT
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/dolinrt/core/modules directory.
 *  \file       htdocs/mymodule/core/modules/modDolInRT.class.php
 *  \ingroup    DolInRT
 *  \brief      Description and activation file for module DolInRT
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module DolInRT
 */
class modDolInRT extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 505050;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'dolinrt';
		...
		$this->description = "Server SOAP Dolibarr / Request Tracker";
		$this->descriptionlong = "Active un server SOAP Dolibarr fournissant une API permettant l'interfacage avec Request Tracker";
		...
		//$this->config_page_url = array("setup.php@dolinrt");
		...
		$this->langfiles = array("langfile@dolinrt");
		...
		if (! isset($conf->dolinrt) || ! isset($conf->dolinrt->enabled))
        {
        	$conf->dolinrt=new stdClass();
        	$conf->dolinrt->enabled=0;
        }
